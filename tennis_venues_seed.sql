...
INSERT INTO t_tennis_venues (
    id, name, city, location, open_time, is_open, price_range, 
    features, description, image_url, sort_order, created_at, updated_at
) VALUES
-- 广州天河体育中心
(1, '广州天河体育中心', '广州', '天河区体育西路', '08:00-20:00', 1, '¥50-120/小时',
...
-- 上海徐家汇体育公园
(4, '上海徐家汇体育公园', '上海', '徐汇区漕溪北路1111号', '06:30-21:30', 1, '¥70-180/小时',
...
-- 杭州黄龙体育中心
(5, '杭州黄龙体育中心', '杭州', '西湖区曙光路黄龙体育中心', '08:00-20:00', 1, '¥45-100/小时',
...
-- 成都猛追湾游泳场网球中心
(6, '成都猛追湾游泳场网球中心', '成都', '成华区猛追湾街168号', '09:00-21:00', 1, '¥40-90/小时',
 JSON_ARRAY('标准场地', '器材租赁', '教练服务'),
 '成都猛追湾游泳场网球中心，环境舒适，价格实惠，是成都市内受欢迎的网球场地。',
 'https://example.com/images/venues/mengzhuiwan-tennis.jpg', 75, NOW(), NOW()),

-- 武汉光谷国际网球中心
(7, '武汉光谷国际网球中心', '武汉', '东湖新技术开发区关山大道', '08:00-21:00', 1, '¥55-130/小时',
...
-- 南京奥体中心网球场
(8, '南京奥体中心网球场', '南京', '建邺区江东中路222号', '07:30-20:30', 1, '¥50-110/小时',
...
-- 西安城市运动公园网球场
(9, '西安城市运动公园网球场', '西安', '未央区凤城八路与明光路交汇处', '08:30-20:00', 1, '¥35-85/小时',
 JSON_ARRAY('标准场地', '器材租赁', '教练服务'),
 '西安城市运动公园网球场，环境舒适，价格实惠，深受网球爱好者喜爱。',
 'https://example.com/images/venues/xian-city-park.jpg', 78, NOW(), NOW()),

-- 青岛国信体育中心
(10, '青岛国信体育中心', '青岛', '崂山区同安路880号', '07:00-21:00', 1, '¥45-105/小时',
...
GROUP BY v.id, v.name, v.city, v.price_range
