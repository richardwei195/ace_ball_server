...
INSERT INTO t_tennis_venues (
    id, name, city, location, open_start_time, open_end_time, booking_start_time, is_open, price_range, 
    features, description, image_url, sort_order, created_at, updated_at
) VALUES
-- 广州天河体育中心 (08:00-20:00)
(1, '广州天河体育中心', '广州', '天河区体育西路', 480, 1200, 'T-1 08:00', 1, '¥50-120/小时',
...
-- 深圳湾体育中心 (06:00-22:00)
(2, '深圳湾体育中心', '深圳', '南山区深圳湾体育中心', 360, 1320, 'T-1 07:00', 1, '¥80-200/小时',
 JSON_ARRAY('专业场地', '夜间照明', '停车便利', '教练服务', '风雨场'),
 '深圳湾体育中心网球场，拥有多片标准网球场地，设施一流，交通便利。',
 'https://example.com/images/venues/shenzhen-bay.jpg', 95, NOW(), NOW()),

-- 北京朝阳公园网球中心 (07:00-21:00)
(3, '北京朝阳公园网球中心', '北京', '朝阳区朝阳公园南路8号', 420, 1260, 'T-2 09:00', 1, '¥60-150/小时',
...
(4, '上海徐家汇体育公园', '上海', '徐汇区漕溪北路1111号', 390, 1290, 'T-1 06:30', 1, '¥70-180/小时',
 JSON_ARRAY('标准场地', '夜间照明', '器材租赁', '教练服务', '淋浴设施', '风雨场'),
...
(5, '杭州黄龙体育中心', '杭州', '西湖区曙光路黄龙体育中心', 480, 1200, 'T-3 10:00', 1, '¥45-100/小时',
 JSON_ARRAY('标准场地', '器材租赁', '教练服务', '停车便利', '室内场地'),
...
(6, '成都猛追湾游泳场网球中心', '成都', '成华区猛追湾街168号', 540, 1260, 'T-1 09:00', 1, '¥40-90/小时',
 JSON_ARRAY('标准场地', '器材租赁', '教练服务', '风雨场', '室内场地'),
...
(7, '武汉光谷国际网球中心', '武汉', '东湖新技术开发区关山大道', 480, 1260, 'T-7 08:00', 1, '¥55-130/小时',
...
(8, '南京奥体中心网球场', '南京', '建邺区江东中路222号', 450, 1230, 'T-1 08:00', 1, '¥50-110/小时',
...
(9, '西安城市运动公园网球场', '西安', '未央区凤城八路与明光路交汇处', 510, 1200, '当日 08:30', 1, '¥35-85/小时',
 JSON_ARRAY('标准场地', '器材租赁', '教练服务'),
 '西安城市运动公园网球场，环境舒适，价格实惠，深受网球爱好者喜爱。',
 'https://example.com/images/venues/xian-city-park.jpg', 78, NOW(), NOW()),

-- 青岛国信体育中心 (07:00-21:00)
(10, '青岛国信体育中心', '青岛', '崂山区同安路880号', 420, 1260, 'T-2 07:00', 1, '¥45-105/小时',
...
GROUP BY v.id, v.name, v.city, v.open_start_time, v.open_end_time, v.booking_start_time, v.price_range
